      ...
      <Card className="w-full max-w-md overflow-hidden border-0 shadow-lg">
        <CardHeader className="flex flex-row items-center gap-4 p-4 bg-gradient-to-r from-emerald-600 to-emerald-500">
          ...
          <div className="flex-1">
            <h2 className="text-white font-medium">Voter ID: {voter.voter_number}</h2>
          </div>
        </CardHeader>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{voter.voter_name}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{voter.father_or_husband_name}</p>
              </div>
            </div>
        ...
        <CardFooter className="p-4 bg-slate-800 text-white">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">Dakshin Goda Ratabarhi Govt. Primary School</span>
          </div>
        </CardFooter>
      </Card>
    </div>
